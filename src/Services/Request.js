...
const Request = async (messages, inputValueParams) => {
    ...
    try {
        const params = {
            messages: messages,
            model: "gpt-3.5-turbo",
            temperature: 0.8, //Controla la aleatoriedad de las respuestas generadas por el modelo. Valores más altos, como 0.8, generarán respuestas más aleatorias, mientras que valores más bajos, como 0.2, generarán respuestas más determinísticas y coherentes.
            max_tokens: 500,
